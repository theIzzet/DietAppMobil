...
namespace DietTracking.API.Migrations
{
    ...
    [Migration("20250521150100_Demandmig")]
    partial class Demandmig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DietPlanEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("DietPlanEntries");
                });

            modelBuilder.Entity("DietTracking.API.Entities.BodyMeasurement", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DietTracking.API.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DietTracking.API.Entities.DietitianExperience", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DietTracking.API.Entities.DietitianPatient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DietTracking.API.Entities.DietitianProfile", b =>
                {
                    ...
                    b.Property<string>("ServiceDiets")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DietTracking.API.Entities.DietitianReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DietTracking.API.Entities.TestResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DietTracking.API.Entities.WeightMeasurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DietTypeDietitianProfile", b =>
                {
                    ...
                    b.ToTable("DietTypeDietitianProfile");
                });
            ...
            modelBuilder.Entity("DietPlan", b =>
                {
                    ...
                    b.HasOne("DietTracking.API.Models.ApplicationUser", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("DietTracking.API.Entities.ChatMessage", b =>
                {
                    b.HasOne("DietTracking.API.Models.ApplicationUser", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DietTracking.API.Models.ApplicationUser", "ToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DietTracking.API.Entities.DietitianReview", b =>
                {
                    ...
                    b.HasOne("DietTracking.API.Models.ApplicationUser", "Reviewer")
                        .WithMany()
            ...
            modelBuilder.Entity("DietTracking.API.Entities.PhysicalActivity", b =>
                {
                    b.HasOne("DietTracking.API.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("DietTracking.API.Entities.PhysicalActivity", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
